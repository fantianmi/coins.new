...
//            });
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        var sidebar = $('.page-sidebar:not(#m_menu)');
        var body = $('body');
        var height;
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('#m_menu.page-sidebar').on('click', 'li > a', function (e) {
            if ($("#top_menu.page-sidebar.navbar-collapse.collapse").is(":visible"))
            {
                return;
            }
            ...
            var the = $(this);
            if ($("#m_menu.page-sidebar.navbar-collapse.collapse").is(":visible"))
            {
