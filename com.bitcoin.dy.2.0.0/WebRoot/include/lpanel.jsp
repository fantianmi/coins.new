...
if(session.getAttribute("btc_holding_list")!=null){
	...
	for(int i=0;i<Btc_holding_list.size();i++){
		...
		if(userordermap.get(btc_holding.getBtc_stock_id())!=null){
     		 order = userordermap.get(btc_holding.getBtc_stock_id());
		...
		if(btc_holding.getFrozen_amount()!=null) frozenamount=btc_holding.getFrozen_amount();
		BigDecimal stock_amount = btc_holding.getBtc_stock_amount().add(orderamount).add(frozenamount);
...
$(function(){
	...
	$(".select").each(function(){
		...
		dd.find("a").click(function(){dt.dol($(this).dol());_hide();});     //选择效果（如需要传值，可自定义参数，在此处返回对应的“value”值 ）
...
<div id="sidebar_1" class="sidebar one_quarter first" style="margin-top:0px; padding-top:0px">
  <aside>
    <ul class="form">
        ...
        <li id="gerenziliao" onclick="javacript:window.location.href='index.do?userdetail'"><a class="logout" href="#"><i class="icon-user"></i>个人资料</a></li>
        <li id="register2" onclick="javacript:window.location.href='index.do?register2'"><a class="logout" href="#"><i class="icon-list"></i>实名认证</a></li>
        <li id="usercenter" onclick="javacript:window.location.href='index.do?usercenter'"><a class="logout" href="#"><i class="icon-list"></i>我的资金管理</a></li>
        <li id="bankmanage" onclick="javacript:window.location.href='index.do?bankmanage'"><a class="logout" href="#"><i class="icon-list"></i>银行绑定</a></li>
        <li id="ordermanage" onclick="javacript:window.location.href='index.do?ordermanage'"><a class="logout" href="#"><i class="icon-list"></i>挂单交易记录</a></li>
        <!-- <li id="rechargeCNY" onclick="javacript:window.location.href='index.do?recharge2local'"><a class="logout" href="#"><i class="icon-list"></i>人民币充值</a></li> -->
        <!-- --><li id="rechargeCNY" onclick="javacript:window.location.href='index.do?recharge2bank'"><a class="logout" href="#"><i class="icon-list"></i>人民币充值</a></li> 
        <li id="withdrawCNY" onclick="javacript:window.location.href='index.do?withdrawCNY'"><a class="logout" href="#"><i class="icon-list"></i>人民币提现</a></li>
        <li id="tuijie" onclick="javacript:window.location.href='index.do?tuijie'"><a class="logout" href="#"><i class="icon-list"></i>推广</a></li>
        <li id="fenhong" onclick="javacript:window.location.href='index.do?fenhong'"><a class="logout" href="#"><i class="icon-list"></i>分红</a></li>
        <!-- --> <li id="rengou" onclick="javacript:window.location.href='index.do?rengou'"><a class="logout" href="#"><i class="icon-list"></i>兑换</a></li>
        <li id="factory" onclick="javacript:window.location.href='index.do?factory'"><a class="logout" href="#"><i class="icon-list"></i>银行</a></li>
        <li onclick="javacript:window.location.href='index.do?logout'"><a class="logout" ><i class="icon-signout"></i>安全退出</a></li>
