...
<div id="sidebar_1" class="sidebar one_quarter first" style="margin-top:0px; padding-top:0px">
  <aside>
    <ul class="form">
        ...
        <li id="luckwheel" onclick="javacript:window.location.href='luckwheel.do'"><a class="logout" href="#"><i class="icon-trophy"></i>大转盘</a></li>
        <li id="ddz" onclick="javacript:window.location.href='game.do?room=1'"><a class="logout" href="#"><i class="icon-trophy"></i>开心斗地主</a></li>
        <li id="maichang" onclick="javacript:window.location.href='farm.do'"><a class="logout" href="#"><i class="icon-trophy"></i>麦田</a></li>
