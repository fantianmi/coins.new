...
$(function(){
    ...
    var App = function(){
        ...
        renderHtml:function(json){
            ...
            for (var i = 0; i < len; i++) {
                html += '<li><a href="http://app.tongbu.com/'+json[i][20]+'.dol"><img src="'+(json[i][10]==''?json[i][5]:"http://image.tongbu.com/userappicon/"+json[i][10].replace("_75.jpg",".jpg"))+'" width="75" height="75"  name="'+(json[i][19]==''?json[i][1]:json[i][19])+'" ver="'+json[i][6]+'" cate="'+json[i][14]+'" star="'+json[i][7]+'"></a></li>'
