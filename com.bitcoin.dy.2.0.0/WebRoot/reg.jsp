        ...
        <div id="wrap">
            ...
            <div id="page-body" style="background-color: #ffffff;">
                ...
                width: 460px;">
                    ...
                    <input type="hidden" name="recommended_user_id" value="<%=recommended_user_id %>" id="recommended_user_id"/>
										<h2>注册</h2>
						    ...
						    margin-right: -30px;
						    padding: 0 30px 25px;">
												<input type="button" name="login"  onclick="regSubmit()" tabindex="6"  value="注册" style="" class="btn blue btn-block"><i class="m-icon-swapright m-icon-white"></i>
						
												<div class="forget-password">
													<h4></h4>
													<a href="index.do?Login" class="">返回登陆</a>
												</div>
											</div>
										</fieldset>
