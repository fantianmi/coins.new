  ...
  <jsp:include page="/include/lpanel.jsp"></jsp:include>
      ...
      <div style="margin-left: 40px; padding-top: 5px;border-bottom: 5px solid #0171C7;" id="usercenter">
        ...
        <form action="bank.do?add" method="post" id="bindbankform">
            ...
            <div class="form-input clear">
          	<label class="one_half first">省 <span class="required">*</span><br>
	  			<select class="select" name="province" id="s1">
		          <option></option>
		        </select>
		        <span>
		    </label>
		    <label class="one_half first">市<span class="required">*</span><br>
            ...
            <div class="form-input clear">
          	<label class="one_half first">区 <span class="required">*</span><br>
            ...
            <div class="form-input clear">
          	<label class="one_half first" for="depositbank">开户行 <span class="required">*</span><br>
            ...
            <div class="form-input clear">
          	<label class="one_half first" for="card">银行卡号<span class="required">*</span><br>
