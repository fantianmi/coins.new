	  ...
	  %>
        ...
        <!-- form row -->
		    ...
		    $(document).ready(function(){
		        ...
		        $("#msgcode").formValidator().inputValidator({min:3,onError:"请输入邮箱验证码"});
		    });
		    </script>
			<!-- validate process -->
        <form action="recharge.do?withdrawCNY" method="post" id="form1">
            <p>
    		...
    		<div class="form-input clear">
              <label class="one_half first" for="msgcode">邮箱验证码 <span class="required">*</span><br>
                <input name="msgcode" id="msgcode" size="22" type="text" style=" width:150px" placeholder="请输入5位邮箱验证码">	
        ...
        <!-- table row -->
	      ...
	      <h1>最近提现记录</h1>
	      <table summary="Summary Here" cellpadding="0" cellspacing="0"  id="usercenter">
	        <thead>
	          <tr>
	            <th width="15%">提现银行</th>
	            <th width="10%">提现账户</th>
	        ...
	        <%}else{
	        	...
	        	for(int i=0;i<btc_withdrawCNY_order_list.size();i++){
	        		...
	        		<%} %>
			            ...
			            <td><%=format.trans(btc_withdrawCNY_order.getBtc_bwo_amount()) %></td>
			            <td><%=format.trans(btc_withdrawCNY_order.getBtc_bwo_poundage()) %></td>
