  ...
  <div id="container">
    ...
    <ul class="list-unstyled ng-scope" ng-controller="NewsCtrl">
			...
			<li class="ng-scope" ng-repeat="item in news">
				<header>
					<h2>
						<a class="ng-binding" href="index.do?newsdetail&contentid=<%=newslist3.getBtc_content_id()%>" target="_blank">
							<%=title %>
						</a>
					</h2>
				...
				<p>
					...
					<a href="index.do?newsdetail&contentid=<%=newslist3.getBtc_content_id()%>" target="_blank" class="link">MORE</a>
				</p>
			</li>
			<%
         } %>
