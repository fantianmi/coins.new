  ...
  <div id="container">
    ...
    <div id="contact" class="clear">
      <div class="one_half first">
        ...
        <p>首先请验证您的身份信息才能找回密码，请输入您要找回的用户名，然后点击确认，我们会把验证信息发到您的邮箱中，请注意查收</p>
        <div id="respond">
          <h2>找回您的<%if(request.getParameter("type").equals("utpass")){%>交易<%} %>密码</h2>
          <form class="rnd5" action="register.do?resetpass" name="form1" id="form1">
            <input type="hidden" name="type" value="<%=request.getAttribute("type").toString() %>">
          	<div class="form-input clear">
              <label class="one_half first" for="usernameinput"><span class="required">*</span><br>
                
              </label>
            </div>
          	<div class="form-input clear">
              <label class="one_half first" for="usernameinput">重置密码<span class="required">*</span><br>
                
              </label>
            </div>
          	<div class="form-input clear">
              <label class="one_half first" for="usernameinput">再次输入<span class="required">*</span><br>
                <input id="password2" name="password2" type="password" class="sz"/>
              </label>
            </div>
             <p>
              <span class="one_half first"><input type="button" onclick="submitForm2('form1')" value="确认" class="button small black rnd8" id="checkbtn"/></span>
              &nbsp;
            </p>
        </div>
      </div>
