...
<head profile="http://gmpg.org/xfn/11">
	...
	function doclickrecharge(){
		...
		if(radiovalue=="ABC"){
			...
			document.getElementById("shoukuanzhanghao").innerHTML="discoverman@163.com";
			document.getElementById("shoukuanren").innerHTML="李*城";
...
<div class="wrapper row3">
  ...
  <jsp:include page="/include/lpanel.jsp"></jsp:include>
      ...
      <div style="margin-left: 40px; padding-top: 5px;border-bottom: 5px solid #0171C7;" id="usercenter">
		<h2 style="margin-top:50px; margin-bottom:0px;color:#0171C7;font-weight: bold;">线下充值</h2>    
	 </div>
	 <div style="margin-left: 40px; padding-top: 5px;" id="usercenter">
        ...
        <!-- validate process -->
			...
			<!-- validate process -->
	        <form action="recharge.do?CNY" method="post" id="form1">
	         <input type="hidden" name="bro_recharge_way" value="线下充值">
			...
			<option value="index.do?recharge2bank"  >网银充值</option>
			<option value="#" selected="selected">线下充值</option>
			</select>
            </label>
            </div>
		</form>
