	...
	function build() {
		...
		svg.BoundingBox = function(x1, y1, x2, y2) { // pass in initial points if you want
			...
			this.addBezierCurve = function(p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y) {
				// from http://blog.hackers-cafe.net/2009/06/how-to-calculate-bezier-curves-bounding.dol
		...
		svg.AspectRatio = function(ctx, aspectRatio, width, desiredWidth, height, desiredHeight, minX, minY, refX, refY) {
			// aspect ratio - http://www.w3.org/TR/SVG/coords.dol#PreserveAspectRatioAttribute
		...
		svg.Element.path = function(node) {
			...
			// TODO: convert to real lexer based on http://www.w3.org/TR/SVG11/paths.dol#PathDataBNF
				...
				while (!pp.isEnd()) {
					...
					case 'A':
						while (!pp.isCommandOrEnd()) {
							...
							// http://www.w3.org/TR/SVG11/implnote.dol#ArcImplementationNotes
							// x1', y1'
