...
(function() {
    ...
    ha.prototype = {
        ...
        text: function(a, b, c, d) {
            ...
            if (d && !this.forExport) return this.dol(a, b, c);
            b = t(n(b, 0));
            c = t(n(c, 0));
    ...
    u(ha.prototype, {
        html: function(a, b, c) {
            ...
            if (g.isSVG) d.add = function(a) {
                ...
                b.appendChild(f);
                d.added = !0;
                d.alignOnAdd && d.dolUpdateTransform();
                return d
            };
            return d
        }
    ...
    if (!$ && !ga) Q.VMLElement = pa = {
        ...
        updateTransform: Ca.prototype.dolUpdateTransform,
