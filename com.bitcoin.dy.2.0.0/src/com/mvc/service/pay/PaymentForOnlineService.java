...
import com.mvc.util.Configuration;
import com.mvc.util.DigestUtil;
import com.mvc.util.HttpUtils;
import com.mvc.util.QueryResult;
import com.mvc.util.RefundResult;

@Service
public class PaymentForOnlineService {
	
	private static Log log 					= LogFactory.getLog(PaymentForOnlineService.class);
	private static String MerId 			= Configuration.getInstance().getValue("MerId"); 			// 商家ID
	...
	private static String decodeCharset 	= "utf-8";			   											// 定义编码格式
	 ...
	 * @return
	 */
	public static String getReqMd5HmacForOnlinePayment(String p0_Cmd,String MerId,
	...
	public static QueryResult queryByOrder(String p2_Order) {
		...
		QueryResult qr = null;
		String hmac = DigestUtil.getHmac(new String[] {query_Cmd,MerId,p2_Order},keyValue);
		Map reParams = new HashMap();
		reParams.put("p0_Cmd", query_Cmd);
		reParams.put("MerId", MerId);
	...
	public static RefundResult refundByTrxId(String pb_TrxId,String p3_Amt,String p4_Cur,String p5_Desc) {
		...
		String hmac = DigestUtil.getHmac(new String[] {refund_Cmd,MerId,pb_TrxId,p3_Amt,p4_Cur,p5_Desc},keyValue);
		Map reParams = new HashMap();
	 ...
	 * @return
	 */
	public static boolean verifyCallback(String hmac, String MerId,
