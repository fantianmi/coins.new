...
public class StockService {
	...
	public Map<String, NaviStockModel> getCoins4CNY(){
		String sql="select s from Btc_stock s where s.is_real_stock='1' and s.is4cny=1";
		...
		if (list.size() != 0) {
			for(int i=0;i<list.size();i++){
				...
				nsm.setLastprice(deals.getLtPrice(stock.getBtc_stock_id(), "CNY"));
