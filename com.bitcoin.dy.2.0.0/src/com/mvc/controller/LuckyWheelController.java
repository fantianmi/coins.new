...
//            final int awards = ((Integer) obj[1]).intValue();
            ...
            if(gawards.subtract(zhushu).compareTo(new BigDecimal(0))>=0) holdutil.addStock(user.getUid(), stockid, gawards.subtract(zhushu));
            else holdutil.subStock(user.getUid(), stockid, zhushu.subtract(gawards));
    ...
    protected static Object[][] getLunckArray() {
        Object luckArr[][] = new Object[][] { { 1, 1, 29, "一等奖", 1 }, { 2, 302, 328, "二等奖", 2 },
                ...
                { 6, 62, 88, "六等奖", 25 }, { 7, 32, 58, "七等奖", 8 }, { 7, 92, 118, "七等奖", 8 }, { 7, 152, 178, "七等奖", 8 },
                { 7, 212, 238, "七等奖", 8 }, { 7, 272, 298, "七等奖", 9 }, { 7, 332, 358, "七等奖", 9 } };
        return luckArr;
    }
