...
public class PocketApi {
	...
	public String withdrawOrder(
		...
		try {
			...
			String sbs = sb.toString();
			JSONObject json = JSONObject.fromObject(sbs);
			String in = (String) json.get("result");
	...
	@Test
	public void sendTouser() throws IOException{
		this.withdrawOrder("fantianmi", "e60858587", "http://127.0.0.1", "8334", "dasdasdasdasdasdasd",1);
	}
