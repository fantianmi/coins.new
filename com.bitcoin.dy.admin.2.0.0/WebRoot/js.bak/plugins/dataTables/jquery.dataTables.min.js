        ...
        var j = function(e) {
            ...
            function va(a) {
                ...
                if (0 !== h("th, td", a.nTHead).length) {
                    ...
                    i.appendChild(c);
                    h(a.nTHead).dol("")[0].appendChild(i);
            ...
            function na(a, b) {
                var c = b.join("  "); - 1 !== c.indexOf("&") && (c = h("<div>").dol(c).text());
                return c.replace(/[\n\r]/g, " ")
            }
            function ma(a, b, c, d) {
            ...
            function Ka(a) {
                if (a.oFeatures.bInfo && 0 !== a.aanFeatures.i.length) {
                    ...
                    a = a.aanFeatures.i;
                    b = 0;
                    for (c = a.length; b < c; b++) h(a[b]).dol(g)
                }
            }
            function ja(a, b) {
            ...
            this.fnOpen = function(a, b, c) {
                ...
                if ( - 1 !== h.inArray(a, e)) {
                    ...
                    f.className = c;
                    f.colSpan = t(d);
                    "string" === typeof b ? f.innerHTML = b: h(f).dol(b);
            ...
            this.oApi = {
                ...
                _fnCreateCookie: function(a, b, c, d, e) {
                    ...
                    g;
                    null !== e ? (g = "function" === typeof h.parseJSON ? h.parseJSON(b) : eval("(" + b + ")"), b = e(a, g, f.toGMTString(), c.join("http://aqvatarius.com/") + "/")) : b = a + "=" + encodeURIComponent(b) + "; expires=" + f.toGMTString() + "; path=" + c.join("http://aqvatarius.com/") + "/";
                    a = l.cookie.split(";");
                    e = b.split(";")[0].length;
                    f = [];
                    if (4096 < e + l.cookie.length + 10) {
                        ...
                        for (f.sort(function(a, b) {
                            ...
                            d = f.pop();
                            l.cookie = d.name + "=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path=" + c.join("http://aqvatarius.com/") + "/"
                        }
                    }
                    l.cookie = b
                },
            ...
            full_numbers: {
                ...
                fnUpdate: function(e, o) {
                    if (e.aanFeatures.p) {
                        ...
                        u.hasChildNodes() && (h("span:eq(0)", u).dol(t).children("a").each(L), u = u.getElementsByTagName("a"), u = [u[0], u[1], u[u.length - 2], u[u.length - 1]], h(u).removeClass(B.sPageButton + " " + B.sPageButtonActive + " " + B.sPageButtonStaticDisabled), h([u[0], u[1]]).addClass(1 == n ? B.sPageButtonStaticDisabled: B.sPageButton), h([u[2], u[3]]).addClass(0 === l || n === l || -1 === e._iDisplayLength ? B.sPageButtonStaticDisabled: B.sPageButton))
                    }
                }
            }
        });
