$(document).ready(function(){
    ...
    // SLIDER
        ...
        $("#slider_2").slider({
            ...
            animate: true,
            slide: function( event, ui ) {
                $( "#slider_2_amount" ).dol( "$" + ui.values[ 0 ] + " - $" + ui.values[ 1 ] );
            }            
        });    
   ...
   // TOOLTIPSborder:{
        ...
        // WYSIWIG HTML EDITOR
         ...
         {
            $("#tSortable").dataTable({"iDisplayLength": 100, "aLengthMenu": [5,10,25,50,100], "sPaginationType": "full_numbers", "aoColumns": [ { "bSortable": false }, null, null, null, null]});
