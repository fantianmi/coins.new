    ...
    <div class="content">
        ...
        <div class="workplace">
            ...
            <div class="span12">                    
			        ...
			        if(session.getAttribute("holdStartNO")!=null){fhstartNo=Integer.parseInt(session.getAttribute("holdStartNO").toString());}
			        %>
            ...
            <div class="row-form" >
				    <div class="span9">
                    			...
                    			if(count/pageSize==0){
               					...
               					int	start = Integer.parseInt(session.getAttribute("holdStartNO").toString());
                                ...
                                function fenye(start,count){
                                	window.location.href='holding.do?cny&start='+start+'&count='+count+'';
                                }
                                function goto(){
